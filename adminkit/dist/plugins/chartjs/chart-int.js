...
$(function() {
	...
	$.ajax({
		type: "POST",
		url: `https://panel.qday-app.com/charts/appVisitUniq`,
		headers: {
...
/* $.each(['appInstall','appRegisterRef'],function(i,e) {
	chartFunc( e)
})*/



//chartFunc( 'appInstall')
//	chartFunc( 'appRegisterRef')
