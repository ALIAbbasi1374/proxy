...
<div class="login-box sty1">
  ...
  <div class="login-logo">
    <a href="index.php"><img src="dist/img/logo-blue.png" alt=""></a>
  </div>
    <p class="login-box-msg">Sign in to start your session</p>
    <form action="http://uxliner.com/adminkit/demo/material/rtl/index.php" method="post">
        ...
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <label>
              <input type="checkbox">
              Remember Me </label>
            <a href="pages-recover-password.php" class="pull-right"><i class="fa fa-lock"></i> Forgot pwd?</a> </div>
        </div>
        <!-- /.col -->
    ...
    <div class="m-t-2">Don't have an account? <a href="pages-register2.php" class="text-center">Sign Up</a></div>
  </div>
  <!-- /.login-box-body -->
</div>
<!-- /.login-box -->
