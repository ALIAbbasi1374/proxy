...
<div class="wrapper boxed-wrapper">
    ...
    <li class="active treeview"> <a href="#"> <i class="icon-layers"></i> <span>Widgets</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
    <ul class="treeview-menu">
    <li><a href="widget-data.php"><i class="fa fa-angle-left"></i> Data Widgets</a></li>
    <li class="active"><a href="widget-apps.php"><i class="fa fa-angle-left"></i> Apps Widgets</a></li>
    </ul>
    </li>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header sty-one">
            ...
            <ol class="breadcrumb">
                <li><a href="#">خانه</a></li>
                <li><i class="fa fa-angle-left"></i> خروجی</li>
            </ol>
        </div>
        ...
        <div class="content">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="text-black inline">تمامی درخواست‌های واریز <span
                                        class="badge badge-primary pfont">0</span></h4>
                            <br><br>
                            <h5 class="text-black inline" id="h5-filter">
                                <span data-att="1" class="badge badge-success">واریز شده</span>
                                <span data-att="0" class="badge badge-danger">واریز نشده</span>
                                <span data-att="-1" class="badge badge-primary">کل</span>
                            </h5>
                            <h5 class="text-black inline mr-5" id="h5-ignore">
                                نادیده گرفته‌ها:
                                <span data-att="0" class="badge badge-success">نمایش</span>
                                <span data-att="1" class="badge badge-danger">عدم نمایش</span>
                            </h5>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <table class="table dataTable no-footer" id="DataTables_Table_0" role="grid"
                                                   aria-describedby="DataTables_Table_0_info" style="width: 1175px;">
                                                <thead>
                                                <tr role="row">
                                                    ...
                                                    <th scope="col" class="sorting" tabindex="0"
                                                        aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                                                        style="width: 131px;"
                                                        aria-label="نامشماره کارت: activate to sort column ascending"
                                                        width="10px">نام<br>شماره کارت
                                                    </th>
                                                    <th scope="col" class="sorting" tabindex="0"
                                                        aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                                                        style="width: 112px;"
                                                    ...
                                                    <th scope="col" class="sorting" tabindex="0"
                                                        aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                                                        style="width: 132px;"
                                                        aria-label="نادیده گرفتن: activate to sort column ascending"
                                                        width="10px">نادیده گرفتن
                                                    </th>
                                                    <th scope="col" class="sorting" tabindex="0"
                                                        aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                                                        style="width: 153px;"
                                            ...
                                            <div id="DataTables_Table_0_processing"
                                    ...
                                    <div class="row">
                                        <div class="col-sm-5">
                                            <div class="dataTables_info" id="DataTables_Table_0_info" role="status"
                                                 aria-live="polite">داده‌ای موجود نیست! (نتیجه جستجو در بین اطلاعات 10
                                                کاربر)
                                            </div>
                                        </div>
                                        <div class="col-sm-7">
            ...
            <script src="dist/plugins/pay/pay-out.js"></script>
