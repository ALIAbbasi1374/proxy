    ...
    <aside class="main-sidebar">
      <div class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="active treeview"> <a href="#"> <span>Icons</span> <i class="icon-energy"></i> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
            <ul class="treeview-menu">
              <li class="active"><a href="icon-fontawesome.php"><i class="fa fa-angle-left"></i> Fontawesome Icons</a></li>
  ...
  -->
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header sty-one">
            ...
            <ol class="breadcrumb">
                <li><a href="#">خانه</a></li>
                <li><i class="fa fa-angle-left"></i> قوانین اپ</li>
            </ol>
        </div>
    ...
    <div>
        <footer class="main-footer">
            ...
            Copyright © 2018 aliabbasi. All rights reserved.
        </footer>
    </div>
</div>
<!-- ./wrapper -->
...
<script src="dist/plugins/setting-app/rules.js"></script>
