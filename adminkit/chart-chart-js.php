...
<!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
  ...
  <li><a href="ui-line-chart.php"><i class="fa fa-angle-left"></i> Carousel</a></li>
  </ul>
  </li>
  ...
  <li class="active"><a href="chart-chart-js.php"><i class="fa fa-angle-left"></i> Chartjs</a></li>
  ...
  <ol class="breadcrumb">
  <li><a href="#">Home</a></li>
  <li><i class="fa fa-angle-right"></i> Chartjs</li>
  </ol>
  </div>
  ...
  <div>
  <canvas id="polararea-chart" height="150"></canvas>
  </div>
  </div>
  </div>
  <div class="col-lg-6">
  ...
  <script src="dist/plugins/popper/popper.min.js">
