...
<head>
    ...
    <!-- jqvmap -->
    <link rel="stylesheet" href="dist/plugins/jqvmap/jqvmap.css"/>
...
<div class="wrapper boxed-wrapper">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="active treeview"> <a href="#"> <span>Maps</span> <i class="icon-location-pin"></i> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="map-vector.php"><i class="fa fa-angle-left"></i> Vector Maps</a></li>
            </ul>
          </li>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header sty-one">
            ...
            <ol class="breadcrumb">
                <li><a href="#">خانه</a></li>
                <li><i class="fa fa-angle-left"></i> حدس تصویر</li>
            </ol>
        </div>
        ...
        <div class="card"> 
                <div class="card-body">
                    <h4 class="text-black inline">حدس تصویر</h4>
                    <button id="addBtn" class="btn btn-success fl-l">تصویر</button>
                    <div class="table-responsive">
                        <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap no-footer">
                                    ...
                                    <table id="example1" class="table table-hover table-bordered">
                                       <thead>
                                         ...
                                         <th scope="col" class="sorting_disabled" rowspan="1" colspan="1"
                                            ...
                                            <th scope="col" class="sorting_disabled" rowspan="1" colspan="1"
                                                style="width: 148px;">پول رایج
                                            </th>

                                            <th scope="col" class="sorting_disabled" rowspan="1" colspan="1"
                                                style="width: 44px;" width="10px">ویرایش
                                            </th>
                                            <th scope="col" class="sorting_disabled" rowspan="1" colspan="1"
                                                style="width: 37px;" width="10px">حذف
                                            </th>
                                          </tr>
                                       </thead>
                                        <tbody></tbody>
                                    </table>
                                    <div id="example1_processing" class="dataTables_processing panel panel-default"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <div class="dataTables_paginate paging_input" id="example1_paginate" style=""><span
                                                class="first paginate_button disabled" id="example1_first"><button
                                                    class="mx-1 btn btn-sm btn-primary">اول</button></span><span
                                                class="previous paginate_button disabled" id="example1_previous"><button
                                                    class="mx-1 btn btn-sm btn-primary">قبلی</button></span><span
                                                class="paginate_page">Page </span><input class="paginate_input"
                                                                                         type="text"><span
                                                class="paginate_of"> of 568</span><span class="next paginate_button"
                                                                                        id="example1_next"><button
                                                    class="mx-1 btn btn-sm btn-primary">بعدی</button></span><span
                                                class="last paginate_button" id="example1_last"><button
                                                    class="mx-1 btn btn-sm btn-primary">آخر</button></span></div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script src="dist/plugins/question/list-pic.js"></script>
