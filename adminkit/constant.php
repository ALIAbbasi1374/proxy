...
<!-- Horizontal Timeline -->
<link rel="stylesheet" href="dist/plugins/horizontaltimeline/timeline-style.css">
...
<div class="wrapper boxed-wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview"> <a href="#"> <span>UI Elements</span> <i class="icon-frame"></i> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="ui-horizontal-timeline.php"><i class="fa fa-angle-left"></i> Horizontal Timeline</a></li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header sty-one">
            <h1>تنظیمات مدیریتی</h1>
            <ol class="breadcrumb">
                <li><a href="#">تنظیمات اپلیکیشن</a></li>
...
<!-- Horizontal Timeline -->
<script src="dist/plugins/horizontaltimeline/modernizr.js"></script>
<script src="dist/plugins/horizontaltimeline/jtline.js"></script>
<script src="dist/plugins/horizontaltimeline/timeline-int.js"></script>
<script>
  $.ajax({
    type: "GET",
    ...
    url: "https://panel.qday-app.com/setting/getConst",
  ...
  $('#btnSubmit').click(function (e) { 
    ...
    $.ajax({
        type: "POST",
        url: "https://panel.qday-app.com/setting/editConst",
        contentType: "application/json; charset=utf-8",
