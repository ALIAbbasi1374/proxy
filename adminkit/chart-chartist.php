...
<div class="wrapper boxed-wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <div class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview"> <a href="#"><span>Charts</span> <i class="icon-chart"></i> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu">
            <li><a href="chart-morris.php"><i class="fa fa-angle-left"></i> Morris Chart</a></li>
            <li class="active"><a href="chart-chartist.php"><i class="fa fa-angle-left"></i> Chartis Chart</a></li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header sty-one">
      ...
      <ol class="breadcrumb">
        <li><a href="#">Home</a></li>
        <li><i class="fa fa-angle-right"></i> Chartist</li>
      </ol>
    </div>
        ...
        <div class="col-lg-6">
          <div class="info-box">
            <div class="col-12">
              <div class="d-flex flex-wrap">
                <div>
                  <h5>Animation Chart</h5>
                </div>
              </div>
            </div>
            <div class="ct-animation-chart" style="height:350px;"></div>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="info-box">
        ...
        <div class="col-lg-6">
          <div class="info-box">
            <div class="col-12">
              <div class="d-flex flex-wrap">
                <div>
                  <h5>SVG animation chart</h5>
                </div>
              </div>
            </div>
            <div class="ct-svg-path-chart" style="height:350px;"></div>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="info-box">
            ...
            <div class="ct-gauge-chart" style="height:350px;"></div>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="info-box">
            ...
            <div class="ct-donute-chart" style="height:350px;"></div>
          </div>
        </div>
      </div>
    </div>
