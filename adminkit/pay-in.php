...
<div class="wrapper boxed-wrapper">
      ...
      <div class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="active treeview"> <a href="#"> <i class="icon-layers"></i> <span>Widgets</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
            <ul class="treeview-menu">
              <li class="active"><a href="widget-data.php"><i class="fa fa-angle-left"></i> Data Widgets</a></li>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header sty-one">
            ...
            <ol class="breadcrumb">
                <li><a href="#">خانه</a></li>
                <li><i class="fa fa-angle-left"></i> ورودی</li>
            </ol>
        </div>
        ...
        <script src="dist/plugins/pay/pay-in.js"></script>
