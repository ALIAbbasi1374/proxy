...
<div class="wrapper boxed-wrapper">
       ...
       <div class="sidebar">
         ...
         <ul class="sidebar-menu" data-widget="tree">
           ...
           <li class="active treeview"> <a href="#"> <i class="icon-grid"></i> <span>Apps</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
             <ul class="treeview-menu">
               <li class="active"><a href="apps-calendar.php"><i class="fa fa-angle-left"></i> Calendar</a></li>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header sty-one">
            ...
            <ol class="breadcrumb">
                <li><a href="#">خانه</a></li>
                <li><i class="fa fa-angle-left"></i> اعضا</li>
            </ol>
        </div>
        ...
        <div class="content">
            ...
            <div class="row">
                ...
                <div class="card-body">
                    <h4 class="text-black inline">اعضا <span class="badge badge-primary">125</span></h4>
                    <br><br>
                    <h5 class="text-black inline">
                        <span data-att="blocked" class="badge badge-dark">بلاک شده‌ها</span>
                        <span data-att="winners" class="badge badge-dark">برندگان</span>
                    </h5>
            ...
            <script src="dist/plugins/members/members.js"></script>
